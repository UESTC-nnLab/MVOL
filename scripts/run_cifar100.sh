...
do    
    ...
    python train_mvol.py --exp-cat-name mvol --auxiliary-dataset RandomImages300k --model-arch wideresnet\
            ...
            --batch-size 128 --ood-batch-size 128 --factor 2
...
for seed in 0 1000 2000 3000 4000
do
    python train_oe_ensemble.py --exp-cat-name oe_ensemble --model-arch wideresnet --ekd-name ekd_augcrop_multiview_oe_seed"$seed" \
        --in-dataset CIFAR-100 --auxiliary-dataset RandomImages300k \
        --batch-size 128 --ood-batch-size 128 --gpu 0 --seed $seed --alpha 0.5 --temperature 2 --beta 0.5 --depth 40 --width 2 --save-epoch 1\
        --teacher-names 'vanilla_seed0,vanilla_seed1000,vanilla_seed2000,vanilla_seed3000,vanilla_seed4000,vanilla_seed5000,vanilla_seed6000,vanilla_seed7000,vanilla_seed8000,vanilla_seed9000'
    python eval_ood_detection.py --if-aux 1 --exp-cat-name oe_ensemble --epochs 100 --in-dataset CIFAR-10 --model-arch wideresnet  --name ekd_augcrop_multiview_oe_seed"$seed" --method maxlogit --gpu 0 --depth 40 --width 2
    python compute_metrics.py --if-aux 1 --exp-cat-name oe_ensemble --in-dataset CIFAR-100 --name ekd_augcrop_multiview_oe_seed"$seed" --method maxlogit --model-arch wideresnet 
done
...
do
    ...
    python train_mvol_ensemble.py --exp-cat-name mvol_ensemble --model-arch wideresnet\
        ...
        --factor 2.0 --batch-size 128 --ood-batch-size 128 --gpu $GPU --seed $seed --alpha 0.5 --temperature 2 --beta 0.5 --depth 40 --width 2\
        --teacher-names 'vanilla_seed0,vanilla_seed1000,vanilla_seed2000,vanilla_seed3000,vanilla_seed4000,vanilla_seed5000,vanilla_seed6000,vanilla_seed7000,vanilla_seed8000,vanilla_seed9000'
